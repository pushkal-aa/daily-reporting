 ...
 * which tells runFullRefresh to always pull fresh BigQuery data.
 *
 * Manual test calls (curl, Apps Script, browser console) should NOT
 * include that param — they default to a visual-only rebuild from the
 * cache, no BigQuery pull, unless you force one via the Config tab:
