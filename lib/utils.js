...
// Last n calendar days ending at the given {y,m,d}, ascending order.
function lastNDaysEnding(endDate, n) {
...
// Convenience: last n days ending "today" (Asia/Kolkata).
function lastNDays(n) {
  return lastNDaysEnding(todayInTZ(), n);
}
...
module.exports = {
  ...
  activePublishers, activeDeals, sumPublisherSpend, lastNDays, lastNDaysEnding, titleCase
};
