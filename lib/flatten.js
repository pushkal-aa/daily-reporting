 ...
 * [Date, Vertical, Geo, Device, Type, Source, Plan Price, Units, Amount]
...
function flattenRows(spendRows, revRows) {
  ...
  revRows.forEach(r => {
    ...
    out.push([r.date, vertical, geo, device, 'Revenue', titleCase(r.partner), planPrice, units, round2(parseFloat(r.revenue) || 0)]);
  });
